...
class NLSN(nn.Module):
    def __init__(self, in_channel=2, n_feats=64, n_resblock=20, upscale_factor=2):
        ...
        m_body = [NonLocalSparseAttention(
            channels=n_feats, chunk_size=144, n_hashes=4, reduction=4, res_scale=1)]
        ...
        m_tail = [
            ...
            nn.Conv2d(
                n_feats, in_channel, kernel_size,
