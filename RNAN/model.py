...
class RNAN(nn.Module):
    def __init__(self, in_channel=2, scale=2, conv=default_conv):
        ...
        # define head module
        modules_head = [conv(in_channel, n_feats, kernel_size)]
        ...
        # define tail module
        modules_tail = [
            conv(n_feats, in_channel, kernel_size)]
    ...
    def forward(self, x):
        ...
        res_clean = F.interpolate(res_clean, size=(h*self.scale, w*self.scale), mode='bicubic')
        return res_clean
